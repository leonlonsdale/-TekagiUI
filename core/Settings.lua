...
TekagiUI.SettingsChanged = function(moduleName, key, value)
    ...
    local module =
        TekagiUI.Modules
        and TekagiUI.Modules[moduleName]


    if module
        and module.Refresh then
...
local function BuildSettingsUI()
    ...
    for moduleName, module in pairs(TekagiUI.Modules) do
        ...
        if module.settings then
            ...
            local subCat =
                Settings.RegisterVerticalLayoutSubcategory(
                    mainCat,
                    subCatName
                )
                ...
                for key, setting in pairs(module.settings.settings) do
                    ...
                    local function GetValue()
                        ...
                        if TekagiUIDB
                            ...
                            and TekagiUIDB[moduleName][key] ~= nil then
                    ...
                    local function SetValue(value)
                        ...
                        TekagiUIDB[moduleName] =
                            TekagiUIDB[moduleName] or {}


                        TekagiUIDB[moduleName][key] =
                            value
