    ...
    settings = {
        ...
        enabled = {
            ...
            callback = function(value)
                ...
                TekagiUIDB.Nameplates =
                    TekagiUIDB.Nameplates or {}
...
local function GetRole(unit)
    ...
    if level == -1
        ...
        or level >= state.referenceLevel + 2 then
    ...
    and level >= state.referenceLevel + 1 then
    ...
    if classification == "minus"
        or classification == "trivial" then
...
local function ApplyColor(unit)
    ...
    if not unit
        or not unit:find("nameplate") then
    ...
    if not plate
        or not plate.UnitFrame
        or not plate.UnitFrame.healthBar then
    ...
    local enabled =
        TekagiUIDB
        and TekagiUIDB.Nameplates
        and TekagiUIDB.Nameplates.enabled ~= false
