...
local UnitMap = {
    player = { 
        ...
        bar = function() return PlayerFrame.PlayerFrameContent.PlayerFrameContentMain.HealthBarsContainer.HealthBar end 
    },
    target = { 
        label = "Class Colored Target Frame", 
        bar = function() return TargetFrame.TargetFrameContent.TargetFrameContentMain.HealthBarsContainer.HealthBar end 
    },
    focus  = { 
        label = "Class Colored Focus Frame", 
        bar = function() return FocusFrame.TargetFrameContent.TargetFrameContentMain.HealthBarsContainer.HealthBar end 
    },
    targettarget = { 
        label = "Class Colored Target-of-Target", 
        bar = function() return TargetFrameToT.HealthBar end 
    },
}
...
local function ApplyColor(unit)
    if not TekagiUIDB or not TekagiUIDB.UnitColors then return end
